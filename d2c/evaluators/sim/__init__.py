...
def bm_eval(
    ...
    :param data_loader: The data loader for benchmark dataset.
    """
    ...
    return BMEval(result_dir=result_dir, agent=agent, env=env, data_loader=data_loader, n_eval_episodes=n_eval_episodes,
